...
const Siderbar = () => {
  return (
    <div>
      <div className="flex flex-col w-64  px-4 py-8 bg-white border-r  border-black dark:bg-gray-800 dark:border-gray-600">
          ...
          <nav>
            ...
            <Link href={"/currency-converter"}>
              ...
              >
                ...
                <span className="mx-4 font-medium">Chuyển Đôỉ Tiền</span>
              </a>
            </Link>
